...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  #read the custom database file path 
...
def generate_launch_description():
  return LaunchDescription([
    ...
    ## adding this to enable saving to a new database path
    DeclareLaunchArgument(
        'database_path',
        default_value='',
        description='Absolute path to RTAB-Map database (.db). If empty, uses default ~/.ros/rtabmap.db.'
    ),
