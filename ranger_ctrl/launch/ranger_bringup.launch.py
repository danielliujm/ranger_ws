...
def generate_launch_description():
    ...
    lidar_bringup_launch = IncludeLaunchDescription (
        PythonLaunchDescriptionSource(
            [os.path.join(get_package_prefix ("velodyne"), "share", "velodyne", "launch", "velodyne-all-nodes-VLP16-launch.py")],
        ),
    ...
    odom_2_tf_launch = IncludeLaunchDescription (
        PythonLaunchDescriptionSource(
            [os.path.join(get_package_prefix ("ranger_ctrl"), "share", "ranger_ctrl", "launch", "odom_2_tf_launch.py")],
        )
    )

    lidar_tf_pub = IncludeLaunchDescription (
        PythonLaunchDescriptionSource(
            [os.path.join(get_package_prefix ("ranger_ctrl"), "share", "ranger_ctrl", "launch", "lidar_tf_pub.launch.py")],
